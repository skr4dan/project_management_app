...
// Protected user routes (require JWT token and role-based access)
...
// Protected project routes (require JWT token and role-based access)
...
// Protected task routes (require JWT token and role-based access)
Route::middleware(['jwt.auth'])->prefix('tasks')->group(function () {
